...
def test_shared_wheel_hashes_are_pinned() -> None:
    ...
    # Published 3.2.1 / 4.2.2rc1 assets (D-17: SHARED-005), independently checked by uv's locked install.
    assert "10ef42f34ace8bb2df5f83ff7de2ceec79b035a25ea0a690e8942bd60d2fb4e3" in records
    assert "0be70bfbb2437dfb080baceb9af41043a09d03b15a358903b8bd7007f5f169b3" in records
