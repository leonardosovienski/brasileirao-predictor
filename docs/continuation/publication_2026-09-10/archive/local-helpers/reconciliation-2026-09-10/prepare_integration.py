...
expected_code = {'brasileirao_predictor/research/calibration_gate.py', 'brasileirao_predictor/research/residual_gate.py', 'tests/test_reconciliation_gate_contracts.py'}
...
assert actual == (expected_code - {'tests/test_reconciliation_gate_contracts.py'}) | guides, actual
new = set(git('ls-files', '--others', '--exclude-standard').decode().splitlines())
assert all(p == 'tests/test_reconciliation_gate_contracts.py' or p.startswith('docs/continuation/reconciliation_2026-09-10/') for p in new)
