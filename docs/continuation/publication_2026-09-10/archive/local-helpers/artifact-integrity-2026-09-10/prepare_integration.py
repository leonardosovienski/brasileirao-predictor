...
base = '2220b42810aea6f656ed196507ff14a62349b83e'
...
expected_code = {'brasileirao_predictor/research/market_residual.py', 'tests/test_residual_artifact_integrity.py'}
...
assert actual == (expected_code - {'tests/test_residual_artifact_integrity.py'}) | guides, actual
new = set(git('ls-files', '--others', '--exclude-standard').decode().splitlines())
assert all(p == 'tests/test_residual_artifact_integrity.py' or p.startswith('docs/continuation/artifact_integrity_2026-09-10/') for p in new)
