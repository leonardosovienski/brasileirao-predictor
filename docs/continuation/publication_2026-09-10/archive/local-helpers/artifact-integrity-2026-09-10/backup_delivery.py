...
out = base / 'ENTREGAS/BRASILEIRAO_ARI_20260910'
bundle = base / 'BACKUPS/brasileirao-predictor-ARI-20260910.bundle'
archive = base / 'ENTREGAS/BRASILEIRAO_ARI_20260910_entrega.zip'
restore = root / 'restored-git.git'
audit = base / 'AUDITORIA/INTEGRIDADE_ARTEFATOS_2026-09-10.json'
...
copy(base / 'INSTRUCOES/PROXIMO_PROMPT_APOS_INTEGRIDADE_ARTEFATOS_2026-09-10.md', Path('PROXIMO_PROMPT.md'))
...
receipt = dict(
    round='ARI-20260910', verified_at=datetime.now(UTC).isoformat(), commit=commit,
