...
wheel = root/'dist-final-02/brasileirao_predictor-0.1.0-py3-none-any.whl'
out = root/'package-smoke-02'
...
changed = ['brasileirao_scripts/coverage_report.py','brasileirao_predictor/kernel_daemon.py','brasileirao_predictor/kernel_message.py','brasileirao_scripts/hotpath_smoke.py','brasileirao_predictor/research/price_strength/capture_decision.py']
