...
from .study import price_policy
...
def decide_captures(captures: list[tuple[bytes, dict[str, Any]]], *, contract: dict[str, Any]) -> dict[str, Any]:
    ...
    policy = price_policy(contract["policy"])
    if policy.reference_books != ("pinnacle",):
