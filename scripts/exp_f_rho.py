...
for scale, lbl in [(1.0, "original"), (0.5, "x0.50"), (0.25, "x0.25"), (0.0, "=0 (NB pura)")]:
    ...
    for g in games:
        ...
        brs.append(brier(p, g["y"]))
        lls.append(-math.log(max(p[g["y"]], 1e-9)))
        pdraws.append(p[1])
        difs.append(p[1] - g["shin"][1])
        for k in range(3):
    ...
    print(
        f"{lbl:<14}{fa:>6.0%}{em:>8.0%}{az:>8.0%}{tot:>9}"
