...
- Checkout de trabalho: `C:\BRASILEIRAO\brasileirao-predictor`.
- Branch de trabalho: `publication-validation-architecture-20260911`. Não presumir que `main` contém esta entrega.
- HEAD conferido antes desta atualização documental: `09821c4596f9d5cf92c6568028402bdb5e287862`.
...
Foram inventariados 275 Markdown versionados antes da atualização, com hashes e verificação de leitura UTF-8. Inventário local: `C:\BRASILEIRAO\work\documentation-sync-20260912`.
