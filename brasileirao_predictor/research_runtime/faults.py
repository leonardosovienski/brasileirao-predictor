"""Edge fault injection for the qualification of the Brasileirão research circuit.

Only active when BRASILEIRAO_RESEARCH_FAULT names a point. In-process points end the real
process with os._exit (no cleanup, no finally blocks); worker points make the real worker,
running under predictor_ops, crash, hang or run slowly. Nothing here mocks predictor_core
or predictor_ops.
"""
...
FAULT_ENV = "BRASILEIRAO_RESEARCH_FAULT"
FAULT_EXIT = 86
# Points where the brasileirao-research process itself dies.
