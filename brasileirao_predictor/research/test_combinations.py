...
from brasileirao_predictor.research.verify_calibration import brier_1x2, load_rows_with_forward_elo
...
def main():
    ...
    rows = load_rows_with_forward_elo(conn, cfg, extra_where="AND sm.date >= '2026-06-01'")
    conn.close()
    ...
    # Todas juntas
    print("Testando: TODAS...", end=" ", flush=True)
    ...
    for r in results:
        print(
            f"{r['features']:<40s} {r['theta_xg']:>+8.4f} "
