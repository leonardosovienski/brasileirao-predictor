...
Roda DEPOIS de `python -m brasileirao_predictor.backtest` (que materializa o ledger).
...
def main():
    ...
    try:
        ...
        sys.exit("tabela backtest_bets não existe — rode `python -m brasileirao_predictor.backtest` antes")
    if not bets:
        sys.exit("ledger vazio — rode `python -m brasileirao_predictor.backtest` antes")
