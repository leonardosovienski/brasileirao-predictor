...
from brasileirao_predictor.obs import get_logger, setup_logging
...
def load_event_data(conn: sqlite3.Connection, market: str, cfg_elo: dict | None = None) -> list[dict]:
...
def _cluster_bootstrap_ci(trades: list[dict], metric: str, iterations: int, rng) -> tuple:
