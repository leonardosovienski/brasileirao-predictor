...
Sofascore e chamando `brasileirao_predictor.research.h9_shadow.emit` — no máximo 1 pick por jogo,
...
Uso (Task Scheduler, cadência sugerida: a cada 15 minutos):
    python brasileirao_scripts/emit_h9_shadow.py
"""
...
from brasileirao_predictor.data.bookmaker_odds import match_fixture  # noqa: E402
from brasileirao_predictor.data.bookmaker_stability import stability_report  # noqa: E402
from brasileirao_predictor.ingest import load_config  # noqa: E402
from brasileirao_predictor.research.h9_shadow import HORIZON, TRIAL, emit  # noqa: E402
...
def run(
    *,
    ...
    try:
        ...
        conn.close()
    if not elo:
        sys.exit("cache Elo vazio — rode python -m brasileirao_predictor.cron_update_models")
