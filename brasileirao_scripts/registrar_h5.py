...
Uso: python brasileirao_scripts/registrar_h5.py
"""
...
def main():
    ...
    reg.register(
        ...
        params={
            ...
            "brasileirao_predictor/xg_model.py, blend das grades de placar, "
            "cache do cron_update_models",
            "captura": "brasileirao_scripts/sombra.py --capture — população paralela à "
    ...
    for t in trials:
        print(f"  - {t['name']} (registrada em {t['registered_at']}, sharpe={t.get('sharpe')})")
