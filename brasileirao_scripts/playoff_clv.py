...
Uso:  python brasileirao_scripts/playoff_clv.py   (a partir da raiz do repo)
...
if not bets:
    ...
    print("   backtest rodar: python -m brasileirao_predictor.backtest)")
else:
    ...
    if falta:
        ...
        print("  -> amostra suficiente: rode 'python -m brasileirao_predictor.bootstrap' para o IC 95%")

print("\nPLAYBOOK DOS PLAYOFFS:")
print("  ANTES do apito (captura abertura dos jogos que o chaveamento resolveu):")
print("    python -m brasileirao_predictor.ingest_sofascore")
print("  DEPOIS dos jogos (refresca resultado, recalcula, mede CLV):")
print("    python -m brasileirao_predictor.ingest          # resultados/fixtures do GitHub (martj42)")
print("    python -m brasileirao_predictor.ingest_sofascore # placar + fechamento + xG")
print("    python -m brasileirao_predictor.cron_update_models")
print("    python -m brasileirao_predictor.backtest")
print("  ACOMPANHAR a qualquer hora:")
print("    python brasileirao_scripts/playoff_clv.py")
