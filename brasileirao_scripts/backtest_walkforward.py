...
Diferença para `python -m brasileirao_predictor.backtest` (params frozen numa única janela):
...
O funil de aposta é o MESMO do brasileirao_predictor.backtest (reuso de _load_odds/_find_odds/
...
from brasileirao_predictor.backtest import (
    _find_event,
    _find_odds,
    _load_ext_index,
    _load_flat_markets,
...
def run_walkforward(cfg, conn):
    ...
    if not odds:
        sys.exit("sem odds no banco — rode python -m brasileirao_predictor.ingest_sofascore")
