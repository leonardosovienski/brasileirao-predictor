...
Replica a metodologia do brasileirao_predictor.backtest (Elo forward, params frozen) mas avalia
TODOS os jogos disputados — nao so os de aposta — e mede skill contra o acaso e
contra o mercado (Shin), que e o juiz de verdade.

Uso:  python brasileirao_scripts/eval_walkforward.py   (a partir da raiz do repo)
"""
