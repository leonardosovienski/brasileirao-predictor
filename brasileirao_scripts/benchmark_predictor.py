...
de H4), sem o ensemble atk/def-xG opcional (`brasileirao_predictor.xg_model`) integrado ao
walk-forward — adicionar exigiria plugar `xg_model` no laço prequential, fora
do escopo deste script de medição.

Uso:
    python brasileirao_scripts/benchmark_predictor.py \\
...
from brasileirao_predictor.dixon_coles import DixonColesMatrix  # noqa: E402
from brasileirao_predictor.evaluator import BrasileiraoDixonColesEvaluator  # noqa: E402
...
from brasileirao_predictor.serving_evaluator import (  # noqa: E402
